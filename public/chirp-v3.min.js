window.ChirpConnect = function (e) {
    function t(r) {
    ...
    var E = n(2), C = n(11), T = Object.prototype.toString;
    e.exports = {
        isArray: r,
        isArrayBuffer: o,
        isBuffer: C,
    ...
    (function (t) {
        ...
        var o = n(0), i = n(13), u = {"Content-Type": "application/x-www-form-urlencoded"}, s = {
            adapter: function () {
                var e;
    ...
    l.nextTick = function (e) {
        ...
        h.push(new a(e, t)), 1 !== h.length || m || o(s)
    ...
    "use strict";
    (function (t) {
        var r = n(0), o = n(14), i = n(16), u = n(17), s = n(18), a = n(5),
        ...
        e.exports = function (e) {
            return new Promise(function (f, p) {
                ...
                if ("test" === t.env.NODE_ENV || "undefined" == typeof window || !window.XDomainRequest || "withCredentials" in h || s(e.url) || (h = new window.XDomainRequest, m = "onload", y = !0, h.onprogress = function () {
                ...
                if (h.open(e.method.toUpperCase(), i(e.url, e.params, e.paramsSerializer), !0), h.timeout = e.timeout, h[m] = function () {
                    ...
                    p(a("Network Error", e, null, h)), h = null
                }, h.ontimeout = function () {
                    p(a("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED", h)), h = null
                }, r.isStandardBrowserEnv()) {
                    var g = n(20),
                        x = (e.withCredentials || s(e.url)) && e.xsrfCookieName ? g.read(e.xsrfCookieName) : void 0;
    ...
    var o = function () {
        ...
        function e(t, n) {
            var o = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "default";
            if (r(this, e), !t || "string" != typeof t || !/[a-zA-Z0-9]{25}/g.test(t)) throw new Error("Invalid application key.");
            if (!(n && n instanceof AudioContext)) throw new Error("A Web Audio Context must be supplied");
            if (!o || "string" != typeof o) throw new Error("Licence information is invalid.");
            this.key = t, this.audioContext = n, this.licenceName = o
        }

        return o(e, [{
            key: "setLicence", value: function (e) {
                if (!e || "string" != typeof e) throw new Error("Licence information is invalid.");
                this.licenceName = e
            }
        }, {
            key: "setAudioContext", value: function (e) {
                if (!(e && e instanceof AudioContext)) throw new Error("audioContext must be an instance of the browser AudioContext");
                this.audioContext = e
            }
        }, {
            key: "arrayToHex", value: function (e) {
                if (!e || 0 === e.length || e.constructor !== Uint8Array) return "";
                var t = void 0, n = void 0, r = "";
                for (n = 0; n < e.length; n++) t = e[n].toString(16), 1 === t.length && (t = "0" + t), r += t;
                return r
            }
        }, {
            key: "send", value: function (e, t) {
                var n = this;
                if (!e || 0 === e.length || e.constructor !== Uint8Array) return void t("Payload needs to be a non empty Uint8Array");
                var r = this.arrayToHex(e);
                (0, u.default)({
                    method: "get",
                    url: "https://audio.chirp.io/v3/" + this.licenceName + "/" + r,
                    responseType: "arraybuffer",
                    headers: {Authorization: "Basic " + window.btoa(this.key + ":")}
                }).then(function (e) {
                    n.audioContext.decodeAudioData(e.data, function (e) {
                        var r = n.audioContext.createBufferSource();
                        r.buffer = e, r.connect(n.audioContext.destination), r.start(0);
                        var o = 1e3 * r.buffer.duration;
                        t && setTimeout(function () {
                            t()
                        }, o)
                    }, function (e) {
                        t("Error decoding Audio from the server in present audio context: " + e.err)
                    })
                }).catch(function (e) {
                    t("Error: Please make sure you have internet connection and that you have set your origin at admin.chirp.io : " + e.response.data.message)
                })
            }
        }]), e
    }();
    ...
    var o = n(0), i = n(2), u = n(12), s = n(1), a = r(s);
    a.Axios = u, a.create = function (e) {
        return r(o.merge(s, e))
    }, a.Cancel = n(7), a.CancelToken = n(26), a.isCancel = n(6), a.all = function (e) {
        return Promise.all(e)
    }, a.spread = n(27), e.exports = a, e.exports.default = a
}, function (e, t) {
    function n(e) {
    ...
    function o(e) {
        for (var t, n, o = String(e), u = "", s = 0, a = i; o.charAt(0 | s) || (a = "=", s % 1); u += a.charAt(63 & t >> 8 - s % 1 * 8)) {
    ...
    e.exports = r.isStandardBrowserEnv() ? function () {
        return {
            write: function (e, t, n, o, i, u) {
                var s = [];
                s.push(e + "=" + encodeURIComponent(t)), r.isNumber(n) && s.push("expires=" + new Date(n).toGMTString()), r.isString(o) && s.push("path=" + o), r.isString(i) && s.push("domain=" + i), !0 === u && s.push("secure"), document.cookie = s.join("; ")
            }, read: function (e) {
    ...
    var o = n(0), i = n(23), u = n(6), s = n(1), a = n(24), c = n(25);
    e.exports = function (e) {
        return r(e), e.baseURL && !a(e.url) && (e.url = c(e.baseURL, e.url)), e.headers = e.headers || {}, e.data = i(e.data, e.headers, e.transformRequest), e.headers = o.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers || {}), o.forEach(["delete", "get", "head", "post", "put", "patch", "common"], function (t) {
            delete e.headers[t]
